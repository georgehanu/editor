import { shape, number, string, bool, array, oneOf } from "prop-types";
import { staticCanvasTypes, staticCanvasDefaults } from "./staticCanvas";
...
export { canvasTypes, canvasDefaults };
